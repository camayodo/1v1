...
```{r}
accessData <- read.csv("shoes.z.csv")
head(accessData)
...
png("TPlot.png")
dev.off()
knitr::include_graphics("/cloud/project/rworksheet4b_camayodo/TPlot.png")
...
png("BlackN_whitePlot.png")
dev.off()
knitr::include_graphics("/cloud/project/rworksheet4b_camayodo/BlackN_whitePlot.png")
